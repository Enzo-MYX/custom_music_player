...
void main() {
  test('MusicLibrary survives JSON serialization', () {
    ...
    expect(
      restored.commands[0].include,
      false,
    );

    expect(
      restored.commands[0].path,
      'Live',
    );

    expect(
      restored.commands[1].include,
      true,
    );

    expect(
      restored.commands[1].path,
      'Live/Favourites',
    );
  });
