...
class _ShuffleScreenState extends State<ShuffleScreen> {
  ...
  Future<void> _startShuffle() async {
    ...
    if (initialState.needsRebuild &&
        !_selectedThroughDropdown) {
      await _openLibraryManager();
      return;
    }
    ...
    try {
      ...
      if (widget.manager.state.songs.isEmpty) {
        setState(() {
          _starting = false;
      ...
      // Starting playback is intentionally not awaited because the
      // future can remain pending while the song is playing.
